...
| `voice-mode` | Opt-in speech-to-speech with your assistant: OpenAI Realtime or Gemini Live (one config line), answers from your records read-only, queues real work, opens apps, sites, folders and records mid-sentence via a fast decision model choosing from a fixed list; barge-in, echo cancellation, global hotkey, measured latency; [guide](docs/voice-mode.md) | ✓ | ✓ | – | – |
